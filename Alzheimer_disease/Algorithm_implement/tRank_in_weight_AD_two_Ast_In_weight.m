...
%%  data import
% Ast
Alp = importdata('select_Ast.csv');
% Alp = importdata('select_Ast_no_impute.csv');
Alp_net = Alp.textdata(2:end,:);
Alp_weight = Alp.data(:,1);

PP = importdata('select_In.csv');
% PP = importdata('select_In_no_impute.csv');
...
% save Ast_In_weighted.mat  Node Rank D_PR D_Rank R_PR R_Rank -v6

...
close all;
%%  data import
Ast = importdata('select_Ex.csv');
% Ast = importdata('select_Ex_no_impute.csv');
...
% save Ex_weighted.mat  Node Rank D_PR D_Rank R_PR R_Rank -v6
...
% end
% fid=fopen('AD_Ex_weight_30.txt','a');
